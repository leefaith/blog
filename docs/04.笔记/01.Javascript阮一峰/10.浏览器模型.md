---
title: 浏览器模型
date: 2020-06-10 11:12:02
permalink: /pages/eea84c
categories: 
  - 笔记
  - Javascript阮一峰
tags: 
...
2. 解析过程中，浏览器**发现`<script>`元素，就暂停解析**，把网页渲染的控制权转**交给 JavaScript 引擎**。
...
## 九、Location 对象，URL 对象，URLSearchParams 对象
...
## 十一、File 对象，FileList 对象，FileReader 对象
